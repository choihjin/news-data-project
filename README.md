...
- 한국경제, AI타임스, 전자신문 등 주요 IT 언론사 데이터 수집
...
### 🔑 1. 키워드 추출
- OpenAI GPT-4 기반 키워드 추출
- 뉴스 본문에서 핵심 키워드 5개 추출
- 불용어 및 일반 단어 제외
- 핵심 개념 및 주제 중심 추출

### 📑 2. 카테고리 분류
- OpenAI GPT-4 기반 카테고리 분류
- 15개 IT 기술 카테고리 분류
- 단일 카테고리 분류 방식
- 카테고리별 신뢰도 점수 산출
